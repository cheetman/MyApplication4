...
public class SettingSceneFragment extends BaseFragment {
    ...
    public static SettingSceneFragment newInstance() {
        SettingSceneFragment fragment = new SettingSceneFragment();
        return fragment;
    }
