...
public class SettingGatewayFirmFragment extends BaseFragment {
    ...
    public static SettingGatewayFirmFragment newInstance() {
        SettingGatewayFirmFragment fragment = new SettingGatewayFirmFragment();
        return fragment;
    }
