...
public class SettingRoomFragment extends BaseFragment {

    @BindView(R.id.tv_oscsite)
    TextView mTvVersionName;


    public static SettingRoomFragment newInstance() {
        SettingRoomFragment fragment = new SettingRoomFragment();
        return fragment;
    }
